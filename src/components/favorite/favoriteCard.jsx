...
const FavoriteCard = () => {
 ...
 if (items.length === 0) {
    return (
      <div className="w-full h-[18rem] shadow-lg bg-white border font-bold text-red-800 text-xl border-red-600 flex flex-col items-center justify-center lg:mt-0 mt-[7rem] gap-4">
        {/* Empty state SVG */}
        <svg
          width="80"
          height="80"
